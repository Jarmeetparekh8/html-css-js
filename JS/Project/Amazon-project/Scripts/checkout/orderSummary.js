...
export function renderOrderSummary(){
  ...
  cart.forEach((cartItem) => {
    ...
    const matchingProductItem = getProduct(productId);
    ...
    cartSummaryHTML += `
      ...
      js-cart-item-container-${matchingProductItem.id}">
  ...
  function deliveryOptionsHTML(matchingProductItem, cartItem){
    ...
    deliveryOptions.forEach((deliveryOption) => {
      ...
      html += `
      <div class="delivery-option js-delivery-option" data-product-id="${matchingProductItem.id}"
